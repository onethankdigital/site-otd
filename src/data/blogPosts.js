  ...
  },
  {
    ...
    secoes: [
      ...
      },
      {
        ...
        corpo: "• Nome exato da empresa (igual ao que está nos documentos)\n• Endereço físico completo e verificado\n• Telefone com DDD\n• Site oficial\n• Categoria principal e categorias secundárias\n• Horário de funcionamento atualizado\n• Descrição da empresa (até 750 caracteres)\n• Atributos do negócio (aceita cartão, tem estacionamento, etc.)\n• Mínimo de 10 fotos atualizadas",
      },
      {
      ...
      },
      {
        ...
        corpo: "O Google trata o GMN como uma rede social. Perfis que publicam regularmente recebem tratamento preferencial no algoritmo.\n\nO que publicar: novidades do negócio, dicas relevantes para seus clientes, promoções ou eventos. Frequência ideal: 1 a 2 vezes por semana. Formato: texto + foto. Duração do post no perfil: 7 dias.",
      },
      {
...
Tudo começa com a <a href="https://developers.facebook.com/documentation/business-messaging/whatsapp/about-the-platform" target="_blank" rel="noopener">API oficial do WhatsApp (Cloud API), documentada pela própria Meta</a>. Soluções não-oficiais, baseadas em automação do WhatsApp Web, funcionam até o dia em que o número é banido — geralmente na pior semana possível. Para uma operação comercial séria, o canal precisa ser oficial, auditável e em <a href="https://business.whatsapp.com/policy" target="_blank" rel="noopener">conformidade com as políticas da Meta</a>. Um detalhe técnico que poucos conhecem: quando o cliente inicia a conversa, abre-se uma janela de atendimento de 24 horas em que a empresa pode responder livremente — a base perfeita para um fluxo receptivo de qualificação.<br><br>
...
Aqui está a diferença entre um robô e uma <a href="/insights/automacao-comercial-o-que-e">automação comercial consultiva</a>. O agente de IA precisa ser construído sobre uma <strong>metodologia de vendas real</strong> — frameworks consultivos como o <a href="https://hbr.org/1988/07/spin-selling" target="_blank" rel="noopener">SPIN Selling</a> — para conduzir a conversa por etapas: entender a situação do lead, identificar o problema, dimensionar a implicação e conectar com a necessidade de solução.<br><br>Um agente bem construído:<br><br>• responde em segundos, em linguagem natural, no tom da marca;<br>• faz perguntas de qualificação sem parecer um interrogatório;<br>• identifica se o lead tem perfil (segmento, porte, urgência);<br>• respeita a <a href="https://www.gov.br/anpd/pt-br" target="_blank" rel="noopener">LGPD</a> no tratamento dos dados coletados;<br>• e sabe a hora de <strong>parar e transferir para o humano</strong> — essa é uma regra de ouro.<br><br>
